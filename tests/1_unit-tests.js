...
suite('UnitTests', () => {
  ...
  suite('Function checkInput()', () => {
    test('Valid "1-9" characters', (done) => {
      const input = ['1', '2', '3', '4', '5', '6', '7', '8', '9'];
      input.forEach((num, i) => {
        assert.strictEqual(Solver.checkInput(num), input[i])
      });
      done();
    });
    ...
    test('Invalid characters (anything other than "1-9") are not accepted', (done) => {
      ...
      input.forEach((num, i) => {
        assert.strictEqual(Solver.checkInput(num), false)
      });
      done();
    });
  });
  
  suite('Function initGrid() checkLength()', () => {
    test('Parses a valid puzzle string into an object', done => {
      const input = '..9..5.1.85.4....2432......1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..';
      const output = [".", ".", "9", ".", ".", "5", ".", "1", ".", "8", "5", ".", "4", ".", ".", ".", ".", "2", "4", "3", "2", ".", ".", ".", ".", ".", ".", "1", ".", ".", ".", "6", "9", ".", "8", "3", ".", "9", ".", ".", ".", ".", ".", "6", ".", "6", "2", ".", "7", "1", ".", ".", ".", "9", ".", ".", ".", ".", ".", ".", "1", "9", "4", "5", ".", ".", ".", ".", "4", ".", "3", "7", ".", "4", ".", "3", ".", ".", "6", ".", "."]
      assert.deepStrictEqual(Solver.initGrid(input), output)
      done();
    });
  ...
  suite('Function validPuzzle()', () => {
    ...
    test('Invalid puzzles fail', done => {
      ...
      assert.strictEqual(Solver.validPuzzle(input), false)
      done();
    });
  });
